...
'simulation/swarm_0' is a folder containg expected example output files from running the simulation in the tutorial linked above after correctly installing Rosetta (https://github.com/lightdock/lightdock/tree/master?tab=readme-ov-file#3-installation):

**The values we want are in the 'gso_X.out' files** (where 'X' is the step number):
...
> ```bash #Coordinates  RecID  LigID  Luciferin  Neighbor's number  Vision Range  Scoring ```
> ```bash ( 8.3619938, -9.0568297, -23.0839562, -0.6368250, -0.1214085,  0.4488531, -0.6150161,  5.2922640,  4.6293871,  5.1679589,  3.6238049,  3.9717360,  7.2390017,  4.5821031,  5.4562578,  1.9734713,  2.9626742,  1.0323748,  5.8207747,  3.4377706,  2.6552282,  4.8705878,  3.0931470,  3.4670304,  3.9487060,  2.4948334,  4.5626560)    0    0  27.83190014  6 0.320  18.65982945 ```
