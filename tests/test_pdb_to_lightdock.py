...
def test_generation_runs_when_requested(sample_input_dirs, monkeypatch):
    """When generate_models is True the generation step is invoked."""
    rec = sample_input_dirs["rec"]
    lig = sample_input_dirs["lig"]
    work_root = sample_input_dirs["work_root"]
    ...
    gen_cmd, _gen_cwd = recorder.calls[2]
